...
class Communications {
  ...
  createImages (){
    ...
    let startMessage = this.createImage('/assets/images/click_start_final.png', 'startMessage', 5, 1, messageSettings)
    let resizeMessage = this.createImage('/assets/images/reload_message.png', 'resizeMessage', 1, 1, messageSettings)
