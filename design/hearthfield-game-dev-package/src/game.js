...
class HearthField {
  ...
  createAudioLibrary (cb) {
    let audioLibrary = {}
    audioLibrary.normal = new Sound('/audio/normal#.wav', 0.3, 2)
    audioLibrary.heart = new Sound('/audio/heart#.wav', 0.4, 2)
    audioLibrary.tiger = new Sound('/audio/tiger#.wav', 0.4, 2)
    audioLibrary.sereno = new Sound('/audio/sereno.wav', 0.4, 1)
    audioLibrary.arrow = new Sound('/audio/arrow.wav', 0.4, 1)
    cb(audioLibrary)
  }
...
function fixAssetPath(path) {
  return path.replace('/assets/images/', '/assets/images/').replace('audio/', '/assets/audio/');
}
